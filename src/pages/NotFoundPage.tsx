          ...
          <div className="flex flex-col items-center gap-8 lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="relative flex items-center justify-center mt-2 sm:mt-6 lg:justify-end lg:order-2 lg:mt-0 lg:pl-8">
              <img
                ...
                className="w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[700px] opacity-50"
              />
            </div>
            ...
            <div className="text-center lg:text-left lg:order-1 max-w-[700px]">
              ...
              >
                ...
                The page you're looking for seems to have gone for a coffee
                break. Don't worry, let's get you back to the warmth of our
                cafe!
              </p>
              <div className="flex flex-col items-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 sm:justify-center lg:justify-start">
                <button
                  onClick={() => navigate('/')}
                ...
                >
                  <Home className="w-5 h-5 mr-2 transition-transform duration-200 group-hover:scale-110" />
                  Back to Home
                </button>

                <a
                  href="tel:+16304005155"
                  className="inline-flex items-center px-8 py-4 text-lg font-semibold transition-all duration-300 transform border rounded-full bg-[#FEF7F3] hover:bg-white"
                  style={{
                    color: '#3B2A20',
                    borderColor: '#D8A24A',
                    textDecoration: 'none',
